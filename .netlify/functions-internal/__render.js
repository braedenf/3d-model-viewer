...
var require_easy_qrcode_min = __commonJS({
  "node_modules/easyqrcodejs/dist/easy.qrcode.min.js"(exports, module2) {
    init_shims();
    !function() {
      "use strict";
      function a(a2, b2) {
      ...
      i = function(a2, b2) {
        ...
        f2.setAttribute("offset", b2), c2.indexOf("rgba") !== -1 ? (d2 = /rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?\.?\d*)\s*\)/gi, e2 = d2.exec(c2), f2.setAttribute("stop-color", a("rgb({r},{g},{b})", { r: e2[1], g: e2[2], b: e2[3] })), f2.setAttribute("stop-opacity", e2[4])) : f2.setAttribute("stop-color", c2), this.__root.appendChild(f2);
      }, h = function(a2, b2) {
        this.__root = a2, this.__ctx = b2;
      }, f = function(a2) {
        ...
        if (arguments.length > 1 ? (b2 = c2, b2.width = arguments[0], b2.height = arguments[1]) : b2 = a2 || c2, !(this instanceof f))
          return new f(b2);
        this.width = b2.width || c2.width, this.height = b2.height || c2.height, this.enableMirroring = b2.enableMirroring !== void 0 ? b2.enableMirroring : c2.enableMirroring, this.canvas = this, this.__document = b2.document || document, b2.ctx ? this.__ctx = b2.ctx : (this.__canvas = this.__document.createElement("canvas"), this.__ctx = this.__canvas.getContext("2d")), this.__setDefaultStyles(), this.__stack = [this.__getStyleState()], this.__groupStack = [], this.__root = this.__document.createElementNS("http://www.w3.org/2000/svg", "svg"), this.__root.setAttribute("version", 1.1), this.__root.setAttribute("xmlns", "http://www.w3.org/2000/svg"), this.__root.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:xlink", "http://www.w3.org/1999/xlink"), this.__root.setAttribute("width", this.width), this.__root.setAttribute("height", this.height), this.__ids = {}, this.__defs = this.__document.createElementNS("http://www.w3.org/2000/svg", "defs"), this.__root.appendChild(this.__defs), this.__currentElement = this.__document.createElementNS("http://www.w3.org/2000/svg", "g"), this.__root.appendChild(this.__currentElement);
        ...
        for (f2 = 0; f2 < n.length; f2++)
          if (i2 = e[n[f2]], j2 = this[n[f2]], i2.apply) {
            if (j2 instanceof h) {
              ...
              c2.setAttribute(i2.apply, a("url(#{id})", { id: j2.__root.getAttribute("id") }));
            else if (i2.apply.indexOf(b2) !== -1 && i2.svg !== j2)
              if (i2.svgAttr !== "stroke" && i2.svgAttr !== "fill" || j2.indexOf("rgba") === -1) {
                var o = i2.svgAttr;
                if (n[f2] === "globalAlpha" && (o = b2 + "-" + i2.svgAttr, c2.getAttribute(o)))
                  continue;
                ...
                q != null && (p *= q), c2.setAttribute(i2.svgAttr + "-opacity", p);
              }
          }
      }, f.prototype.__closestGroupOrSvg = function(a2) {
        return a2 = a2 || this.__currentElement, a2.nodeName === "g" || a2.nodeName === "svg" ? a2 : this.__closestGroupOrSvg(a2.parentNode);
        ...
        if (b2.childNodes.length > 0) {
          this.__currentElement.nodeName === "path" && (this.__currentElementsToStyle || (this.__currentElementsToStyle = { element: b2, children: [] }), this.__currentElementsToStyle.children.push(this.__currentElement), this.__applyCurrentDefaultPath());
        ...
        c2 === void 0 && (c2 = b2), this.__addTransform(a("scale({x},{y})", { x: b2, y: c2 }));
        ...
        a2.nodeName === "path" ? a2.setAttribute("d", this.__currentDefaultPath) : console.error("Attempted to apply path command to node", a2.nodeName);
        ...
        this.__currentElement.nodeName !== "path" && this.beginPath(), this.__currentPosition = { x: b2, y: c2 }, this.__addPathCommand(a("M {x} {y}", { x: b2, y: c2 }));
      ...
      f.prototype.arcTo = function(a2, b2, c2, d2, e2) {
        ...
        if (f2 !== void 0 && g2 !== void 0) {
          if (e2 < 0)
            throw new Error("IndexSizeError: The radius provided (" + e2 + ") is negative.");
          if (f2 === a2 && g2 === b2 || a2 === c2 && b2 === d2 || e2 === 0)
            return void this.lineTo(a2, b2);
          var h2 = j([f2 - a2, g2 - b2]), i2 = j([c2 - a2, d2 - b2]);
          if (h2[0] * i2[1] == h2[1] * i2[0])
            return void this.lineTo(a2, b2);
          var k = h2[0] * i2[0] + h2[1] * i2[1], l = Math.acos(Math.abs(k)), m = j([h2[0] + i2[0], h2[1] + i2[1]]), n = e2 / Math.sin(l / 2), o = a2 + n * m[0], p = b2 + n * m[1], q = [-h2[1], h2[0]], r = [i2[1], -i2[0]], s2 = function(a3) {
            var b3 = a3[0];
        ...
        this.__currentElement.nodeName !== "path" && this.beginPath(), this.moveTo(a2, b2), this.lineTo(a2 + c2, b2), this.lineTo(a2 + c2, b2 + d2), this.lineTo(a2, b2 + d2), this.lineTo(a2, b2), this.closePath();
        ...
        if (a2 === 0 && b2 === 0 && c2 === this.width && d2 === this.height)
        ...
        return this.__fontUnderline === "underline" && (c2.decoration = "underline"), this.__fontHref && (c2.href = this.__fontHref), c2;
        ...
        var a2, b2, c2, d2, e2, g2, h2, i2, j2, k, l, m, n, o, p = Array.prototype.slice.call(arguments), q = p[0], r = 0, s2 = 0;
        if (p.length === 3)
          ...
          r = p[1], s2 = p[2], e2 = p[3], g2 = p[4], a2 = p[5], b2 = p[6], c2 = p[7], d2 = p[8];
        }
        ...
        if (q instanceof f) {
          ...
          q.nodeName !== "CANVAS" && q.nodeName !== "IMG" || (l = this.__createElement("image"), l.setAttribute("width", c2), l.setAttribute("height", d2), l.setAttribute("preserveAspectRatio", "none"), l.setAttribute("opacity", this.globalAlpha), (r || s2 || e2 !== q.width || g2 !== q.height) && (m = this.__document.createElement("canvas"), m.width = c2, m.height = d2, n = m.getContext("2d"), n.drawImage(q, r, s2, e2, g2, 0, 0, c2, d2), q = m), l.setAttribute("transform", t), l.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", q.nodeName === "CANVAS" ? q.toDataURL() : q.originalSrc), h2.appendChild(l));
      ...
      }, typeof window == "object" && (window.C2S = f), typeof module2 == "object" && typeof module2.exports == "object" && (module2.exports = f);
    }(), function() {
      "use strict";
      function a(a2, b2) {
        this.mode = q.MODE_8BIT_BYTE, this.data = a2, this.parsedData = [];
        for (var c2 = 0, d2 = this.data.length; c2 < d2; c2++) {
          var e2 = [], f2 = this.data.charCodeAt(c2);
          b2 ? e2[0] = f2 : f2 > 65536 ? (e2[0] = 240 | (1835008 & f2) >>> 18, e2[1] = 128 | (258048 & f2) >>> 12, e2[2] = 128 | (4032 & f2) >>> 6, e2[3] = 128 | 63 & f2) : f2 > 2048 ? (e2[0] = 224 | (61440 & f2) >>> 12, e2[1] = 128 | (4032 & f2) >>> 6, e2[2] = 128 | 63 & f2) : f2 > 128 ? (e2[0] = 192 | (1984 & f2) >>> 6, e2[1] = 128 | 63 & f2) : e2[0] = f2, this.parsedData.push(e2);
        }
      ...
      function c(a2, b2) {
        ...
        for (var c2 = 0; c2 < a2.length && a2[c2] == 0; )
          c2++;
      ...
      function g(a2, b2) {
        ...
        return b2.version != 0 && (d2 <= b2.version ? (d2 = b2.version, b2.runVersion = d2) : (console.warn("QR Code version " + b2.version + " too small, run version use " + d2), b2.runVersion = d2)), d2;
      }
      function h(a2) {
        var b2 = encodeURI(a2).toString().replace(/\%[0-9a-fA-F]{2}/g, "a");
        return b2.length + (b2.length != a2.length ? 3 : 0);
      }
      var i, j, k = typeof global == "object" && global && global.Object === Object && global, l = typeof self == "object" && self && self.Object === Object && self, m = k || l || Function("return this")(), n = typeof exports == "object" && exports && !exports.nodeType && exports, o = n && typeof module2 == "object" && module2 && !module2.nodeType && module2, p = m.QRCode;
      a.prototype = { getLength: function(a2) {
        return this.parsedData.length;
      }, write: function(a2) {
        for (var b2 = 0, c2 = this.parsedData.length; b2 < c2; b2++)
          a2.put(this.parsedData[b2], 8);
      } }, b.prototype = { addData: function(b2, c2) {
        var d2 = new a(b2, c2);
        this.dataList.push(d2), this.dataCache = null;
        ...
        if (c2[1]) {
          ...
          return c2[2] == "A" && (d2 = "A" + c2[1]), { isDark: c2[0], type: d2 };
        }
        return null;
        ...
        this.setupPositionProbePattern(0, 0, "TL"), this.setupPositionProbePattern(this.moduleCount - 7, 0, "BL"), this.setupPositionProbePattern(0, this.moduleCount - 7, "TR"), this.setupPositionAdjustPattern("A"), this.setupTimingPattern(), this.setupTypeInfo(a2, c2), this.typeNumber >= 7 && this.setupTypeNumber(a2), this.dataCache == null && (this.dataCache = b.createData(this.typeNumber, this.errorCorrectLevel, this.dataList)), this.mapData(this.dataCache, c2);
      }, setupPositionProbePattern: function(a2, b2, c2) {
        for (var d2 = -1; d2 <= 7; d2++)
          if (!(a2 + d2 <= -1 || this.moduleCount <= a2 + d2))
            for (var e2 = -1; e2 <= 7; e2++)
              b2 + e2 <= -1 || this.moduleCount <= b2 + e2 || (0 <= d2 && d2 <= 6 && (e2 == 0 || e2 == 6) || 0 <= e2 && e2 <= 6 && (d2 == 0 || d2 == 6) || 2 <= d2 && d2 <= 4 && 2 <= e2 && e2 <= 4 ? (this.modules[a2 + d2][b2 + e2][0] = true, this.modules[a2 + d2][b2 + e2][2] = c2, this.modules[a2 + d2][b2 + e2][1] = d2 == -0 || e2 == -0 || d2 == 6 || e2 == 6 ? "O" : "I") : this.modules[a2 + d2][b2 + e2][0] = false);
      }, getBestMaskPattern: function() {
        for (var a2 = 0, b2 = 0, c2 = 0; c2 < 8; c2++) {
          this.makeImpl(true, c2);
          var d2 = t.getLostPoint(this);
          (c2 == 0 || a2 > d2) && (a2 = d2, b2 = c2);
        }
        return b2;
        ...
        for (var a2 = 8; a2 < this.moduleCount - 8; a2++)
          this.modules[a2][6][0] == null && (this.modules[a2][6][0] = a2 % 2 == 0);
        for (var b2 = 8; b2 < this.moduleCount - 8; b2++)
          this.modules[6][b2][0] == null && (this.modules[6][b2][0] = b2 % 2 == 0);
        ...
        for (var b2 = t.getPatternPosition(this.typeNumber), c2 = 0; c2 < b2.length; c2++)
          for (var d2 = 0; d2 < b2.length; d2++) {
            ...
            if (this.modules[e2][f2][0] == null)
              for (var g2 = -2; g2 <= 2; g2++)
                for (var h2 = -2; h2 <= 2; h2++)
                  g2 == -2 || g2 == 2 || h2 == -2 || h2 == 2 || g2 == 0 && h2 == 0 ? (this.modules[e2 + g2][f2 + h2][0] = true, this.modules[e2 + g2][f2 + h2][2] = a2, this.modules[e2 + g2][f2 + h2][1] = g2 == -2 || h2 == -2 || g2 == 2 || h2 == 2 ? "O" : "I") : this.modules[e2 + g2][f2 + h2][0] = false;
          }
        ...
        for (var c2 = -1, d2 = this.moduleCount - 1, e2 = 7, f2 = 0, g2 = this.moduleCount - 1; g2 > 0; g2 -= 2)
          for (g2 == 6 && g2--; ; ) {
            for (var h2 = 0; h2 < 2; h2++)
              if (this.modules[d2][g2 - h2][0] == null) {
                var i2 = false;
                f2 < a2.length && (i2 = (a2[f2] >>> e2 & 1) == 1);
                var j2 = t.getMask(b2, d2, g2 - h2);
                j2 && (i2 = !i2), this.modules[d2][g2 - h2][0] = i2, e2--, e2 == -1 && (f2++, e2 = 7);
              }
            ...
            for (var f2 = 0, g2 = a2.isDark(d2, e2), h2 = -1; h2 <= 1; h2++)
              if (!(d2 + h2 < 0 || b2 <= d2 + h2))
                for (var i2 = -1; i2 <= 1; i2++)
                  e2 + i2 < 0 || b2 <= e2 + i2 || h2 == 0 && i2 == 0 || g2 == a2.isDark(d2 + h2, e2 + i2) && f2++;
            f2 > 5 && (c2 += 3 + f2 - 5);
          }
        for (var d2 = 0; d2 < b2 - 1; d2++)
          for (var e2 = 0; e2 < b2 - 1; e2++) {
            var j2 = 0;
            a2.isDark(d2, e2) && j2++, a2.isDark(d2 + 1, e2) && j2++, a2.isDark(d2, e2 + 1) && j2++, a2.isDark(d2 + 1, e2 + 1) && j2++, j2 != 0 && j2 != 4 || (c2 += 3);
          }
      ...
      c.prototype = { get: function(a2) {
        ...
        return (this.buffer[b2] >>> 7 - a2 % 8 & 1) == 1;
      }, put: function(a2, b2) {
        for (var c2 = 0; c2 < b2; c2++)
          this.putBit((a2 >>> b2 - c2 - 1 & 1) == 1);
      ...
      var w = [[17, 14, 11, 7], [32, 26, 20, 14], [53, 42, 32, 24], [78, 62, 46, 34], [106, 84, 60, 44], [134, 106, 74, 58], [154, 122, 86, 64], [192, 152, 108, 84], [230, 180, 130, 98], [271, 213, 151, 119], [321, 251, 177, 137], [367, 287, 203, 155], [425, 331, 241, 177], [458, 362, 258, 194], [520, 412, 292, 220], [586, 450, 322, 250], [644, 504, 364, 280], [718, 560, 394, 310], [792, 624, 442, 338], [858, 666, 482, 382], [929, 711, 509, 403], [1003, 779, 565, 439], [1091, 857, 611, 461], [1171, 911, 661, 511], [1273, 997, 715, 535], [1367, 1059, 751, 593], [1465, 1125, 805, 625], [1528, 1190, 868, 658], [1628, 1264, 908, 698], [1732, 1370, 982, 742], [1840, 1452, 1030, 790], [1952, 1538, 1112, 842], [2068, 1628, 1168, 898], [2188, 1722, 1228, 958], [2303, 1809, 1283, 983], [2431, 1911, 1351, 1051], [2563, 1989, 1423, 1093], [2699, 2099, 1499, 1139], [2809, 2213, 1579, 1219], [2953, 2331, 1663, 1273]], x = function() {
        ...
        function b2(a3, b3) {
          var c3 = this;
          if (c3._fFail = b3, c3._fSuccess = a3, c3._bSupportDataURI === null) {
          ...
          c3._bSupportDataURI === true && c3._fSuccess ? c3._fSuccess.call(c3) : c3._bSupportDataURI === false && c3._fFail && c3._fFail.call(c3);
        }
        if (m._android && m._android <= 2.1) {
          ...
          CanvasRenderingContext2D.prototype.drawImage = function(a3, b3, e3, f2, g2, h2, i2, j2, k2) {
            if ("nodeName" in a3 && /img/i.test(a3.nodeName))
              ...
              j2 === void 0 && (arguments[1] *= c2, arguments[2] *= c2, arguments[3] *= c2, arguments[4] *= c2);
            d2.apply(this, arguments);
          };
        }
        var e2 = function(a3, b3) {
          this._bIsPainted = false, this._android = f(), this._el = a3, this._htOption = b3, this._htOption.drawer == "svg" ? (this._oContext = {}, this._elCanvas = {}) : (this._elCanvas = document.createElement("canvas"), this._el.appendChild(this._elCanvas), this._oContext = this._elCanvas.getContext("2d")), this._bSupportDataURI = null, this.dataURL = null;
        };
        return e2.prototype.draw = function(a3) {
          ...
          function c3(a4) {
            function c4(a5) {
              ...
              var f3, g3;
              a5.naturalWidth === void 0 ? (f3 = a5.width, g3 = a5.height) : (f3 = a5.naturalWidth, g3 = a5.naturalHeight), (d3.logoMaxWidth || d3.logoMaxHeight) && (d3.logoMaxWidth && f3 <= c5 && (c5 = f3), d3.logoMaxHeight && g3 <= e4 && (e4 = g3), f3 <= c5 && g3 <= e4 && (c5 = f3, e4 = g3));
              ...
              (d3.logoMaxWidth || d3.logoMaxHeight) && (c5 = l3, e4 = m3, i4 = (d3.width + 2 * d3.quietZone - c5) / 2, j4 = (d3.height + d3.titleHeight + 2 * d3.quietZone - e4) / 2), d3.logoBackgroundTransparent || (h2.fillStyle = d3.logoBackgroundColor, h2.fillRect(i4, j4, c5, e4)), h2.drawImage(a5, i4 + (c5 - l3) / 2, j4 + (e4 - m3) / 2, l3, m3), b3(), s3._bIsPainted = true, s3.makeImage();
            }
            ...
            for (var i3 = 0; i3 < e3; i3++)
              for (var j3 = 0; j3 < e3; j3++) {
                ...
                h2.lineWidth = 0;
                var p2, q2;
                n2 ? (p2 = d3[n2.type] || d3[n2.type.substring(0, 2)] || d3.colorDark, q2 = d3.colorLight) : d3.backgroundImage ? (q2 = "rgba(0,0,0,0)", i3 == 6 ? d3.autoColor ? (p2 = d3.timing_H || d3.timing || d3.autoColorDark, q2 = d3.timing_H || d3.timing || d3.autoColorLight) : p2 = d3.timing_H || d3.timing || d3.colorDark : j3 == 6 ? d3.autoColor ? (p2 = d3.timing_V || d3.timing || d3.autoColorDark, q2 = d3.timing_V || d3.timing || d3.autoColorLight) : p2 = d3.timing_V || d3.timing || d3.colorDark : d3.autoColor ? (p2 = d3.autoColorDark, q2 = d3.autoColorLight) : p2 = d3.colorDark) : (p2 = i3 == 6 ? d3.timing_H || d3.timing || d3.colorDark : j3 == 6 ? d3.timing_V || d3.timing || d3.colorDark : d3.colorDark, q2 = d3.colorLight), h2.strokeStyle = m2 ? p2 : q2, h2.fillStyle = m2 ? p2 : q2, n2 ? (o2 = n2.type == "AO" ? d3.dotScaleAO : n2.type == "AI" ? d3.dotScaleAI : 1, d3.backgroundImage && d3.autoColor ? (p2 = (n2.type == "AO" ? d3.AI : d3.AO) || d3.autoColorDark, q2 = d3.autoColorLight) : p2 = (n2.type == "AO" ? d3.AI : d3.AO) || p2, m2 = n2.isDark, h2.fillRect(k2 + f2 * (1 - o2) / 2, d3.titleHeight + l2 + g2 * (1 - o2) / 2, f2 * o2, g2 * o2)) : i3 == 6 ? (o2 = d3.dotScaleTiming_H, h2.fillRect(k2 + f2 * (1 - o2) / 2, d3.titleHeight + l2 + g2 * (1 - o2) / 2, f2 * o2, g2 * o2)) : j3 == 6 ? (o2 = d3.dotScaleTiming_V, h2.fillRect(k2 + f2 * (1 - o2) / 2, d3.titleHeight + l2 + g2 * (1 - o2) / 2, f2 * o2, g2 * o2)) : (d3.backgroundImage, h2.fillRect(k2 + f2 * (1 - o2) / 2, d3.titleHeight + l2 + g2 * (1 - o2) / 2, f2 * o2, g2 * o2)), d3.dotScale == 1 || n2 || (h2.strokeStyle = d3.colorLight);
              }
            if (d3.title && (h2.fillStyle = d3.titleBackgroundColor, h2.fillRect(0, 0, this._elCanvas.width, d3.titleHeight + d3.quietZone), h2.font = d3.titleFont, h2.fillStyle = d3.titleColor, h2.textAlign = "center", h2.fillText(d3.title, this._elCanvas.width / 2, +d3.quietZone + d3.titleTop)), d3.subTitle && (h2.font = d3.subTitleFont, h2.fillStyle = d3.subTitleColor, h2.fillText(d3.subTitle, this._elCanvas.width / 2, +d3.quietZone + d3.subTitleTop)), d3.logo) {
              var r2 = new Image(), s3 = this;
              r2.onload = function() {
                c4(r2);
              }, r2.onerror = function(a5) {
                console.error(a5);
              }, d3.crossOrigin != null && (r2.crossOrigin = d3.crossOrigin), r2.originalSrc = d3.logo, r2.src = d3.logo;
            } else
              b3(), this._bIsPainted = true, this.makeImage();
          }
          var d3 = this._htOption;
          d3.title || d3.subTitle || (d3.height -= d3.titleHeight, d3.titleHeight = 0);
          var e3 = a3.getModuleCount(), f2 = Math.round(d3.width / e3), g2 = Math.round((d3.height - d3.titleHeight) / e3);
          f2 <= 1 && (f2 = 1), g2 <= 1 && (g2 = 1), d3.width = f2 * e3, d3.height = g2 * e3 + d3.titleHeight, d3.quietZone = Math.round(d3.quietZone), this._elCanvas.width = d3.width + 2 * d3.quietZone, this._elCanvas.height = d3.height + 2 * d3.quietZone, this._htOption.drawer != "canvas" && (this._oContext = new C2S(this._elCanvas.width, this._elCanvas.height)), this.clear();
          ...
          if (d3.backgroundImage) {
            var j2 = new Image();
            j2.onload = function() {
              h2.globalAlpha = 1, h2.globalAlpha = d3.backgroundImageAlpha, h2.drawImage(j2, 0, d3.titleHeight, d3.width + 2 * d3.quietZone, d3.height + 2 * d3.quietZone - d3.titleHeight), h2.globalAlpha = 1, c3.call(i2, a3);
            }, d3.crossOrigin != null && (j2.crossOrigin = d3.crossOrigin), j2.originalSrc = d3.backgroundImage, j2.src = d3.backgroundImage;
          } else
            c3.call(i2, a3);
        ...
        return a2.prototype.draw = function(a3) {
          ...
          for (var p2 = 0; p2 < d2; p2++) {
            ...
            for (var q2 = 0; q2 < d2; q2++) {
              var r2 = a3.isDark(p2, q2), s3 = a3.getEye(p2, q2);
              if (s3) {
                r2 = s3.isDark;
                var t2 = s3.type, u2 = b2[t2] || b2[t2.substring(0, 2)] || k2;
                ...
                var v2 = b2.colorDark;
                p2 == 6 ? (v2 = b2.timing_H || b2.timing || k2, g2.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + e2 + "px;height:" + f2 + "px;background-color:" + (r2 ? v2 : l2) + ';"></td>')) : q2 == 6 ? (v2 = b2.timing_V || b2.timing || k2, g2.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + e2 + "px;height:" + f2 + "px;background-color:" + (r2 ? v2 : l2) + ';"></td>')) : g2.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + e2 + "px;height:" + f2 + 'px;"><div style="display:inline-block;width:' + i2 + "px;height:" + j2 + "px;background-color:" + (r2 ? v2 : b2.colorLight) + ';"></div></td>');
              }
            }
            g2.push("</tr>");
          }
          if (g2.push("</table>"), g2.push("</div>"), b2.logo) {
            var w2 = new Image();
            b2.crossOrigin != null && (w2.crossOrigin = b2.crossOrigin), w2.src = b2.logo;
      ...
      j = function(a2, b2) {
        ...
        this._oQRCode = new b(g(a2, this._htOption), this._htOption.correctLevel), this._oQRCode.addData(a2, this._htOption.binary), this._oQRCode.make(), this._htOption.tooltip && (this._el.title = a2), this._oDrawing.draw(this._oQRCode);
      ...
      }, j.CorrectLevel = r, typeof define == "function" && (define.amd || define.cmd) ? define([], function() {
        return j;
...
var import_easyqrcodejs = __toModule(require_easy_qrcode_min());
function run(fn) {
  return fn();
}
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-113b344c.js",
      css: [assets + "/_app/assets/start-0826e215.css"],
      js: [assets + "/_app/start-113b344c.js", assets + "/_app/chunks/vendor-ba0ca9c1.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-98a7725d.js", "css": ["assets/pages/__layout.svelte-1d108c73.css"], "js": ["pages/__layout.svelte-98a7725d.js", "chunks/vendor-ba0ca9c1.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-d3be27e5.js", "css": [], "js": ["error.svelte-d3be27e5.js", "chunks/vendor-ba0ca9c1.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-98e2b2a0.js", "css": ["assets/pages/index.svelte-400129a4.css"], "js": ["pages/index.svelte-98e2b2a0.js", "chunks/vendor-ba0ca9c1.js"], "styles": [] } };
